...
<form name="Adding feedback" method="post" action="/displayingfeedback" modelAttribute="feedback" enctype="multipart/form-data">
...
<td><textarea name="feedbackDescription" rows="5" cols="27">
</textarea></td>
</tr>
